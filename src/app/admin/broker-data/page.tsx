...
const TILES = [
  ...
  { key: "stock-turn",     title: "Stock turn bonuses",    desc: "Bonus paid in return for registering by a deadline.",            href: "/admin/broker-data/stock-turn",  tone: "from-amber-500 to-orange-700",  live: false },
  { key: "interest-grids", title: "Interest + deposit grids", desc: "Per-term, per-customer-type rates for PCP / HP / HPB / CH.",  href: "/admin/broker-data/interest",    tone: "from-sky-500 to-indigo-700",    live: false },
