...
import { completeBrokerSetupAction } from "./actions";
...
export function BrokerSetupForm({ token }: { token: string }) {
  const [state, action, pending] = useActionState(completeBrokerSetupAction, null as { error?: string } | null);
