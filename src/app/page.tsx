...
const TILES: Tile[] = [
  ...
  { key: "forecast",  href: "/forecast",  title: "Forecast",  desc: "Monthly profit forecasts — Lease Car, Lease CV and General Overheads from dealbook uploads.", tone: "from-cyan-500 to-blue-700" },
