...
export const BROKER_TERMS_VERSION = "2026-09-03b";
...
//
// Deliberately no party name: "we" and "us" throughout, so the same wording
// drops into a paper agreement that names the parties in its own preamble
// without saying it twice, and does not need reissuing if the trading name
// changes. Do not reintroduce a company name here.
export const BROKER_TERMS: { heading: string; body: string }[] = [
  {
    heading: "This access is personal to you",
    body:
      "Your sign-in is issued to you by name. Do not share your password, let anyone else use your account, or sign in on a device other people can use unattended. We create and remove every account on this portal.",
  },
  {
    heading: "The stock list is confidential",
    body:
      "Vehicle availability, specification and arrival dates shown here are commercially confidential. They are provided so you can quote your own customers — nothing more.",
  },
  {
  ...
  },
  {
    ...
    body:
      "Attempts to screenshot, print, or remove the watermark are logged against your account and reported to us automatically.",
  },
  {
    heading: "Breach ends your access",
    body:
      "Sharing this information outside your firm is a breach of these terms and of the agreement between us and your company. We may withdraw your access, and your company's access, at any time and without notice.",
  },
];
