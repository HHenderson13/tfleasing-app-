...
export const PROPOSAL_SECTION_STATUSES: ProposalStatus[] = [
  "proposal_received", "accepted", "declined", "referred_to_dealer", "referred_to_underwriter", "not_eligible", "lost_sale",
];

// Terminal statuses — no further transitions allowed.
export const TERMINAL_STATUSES: ProposalStatus[] = ["lost_sale", "not_eligible"];
